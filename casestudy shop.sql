...
price >= (select max(price) as h2 from products)
...
SELECt * FROM (
SELECT c.customer_id,c.first_name,c.last_name,
dense_rank() over(order by No_of_orders desc) most_orders
FROM order_cnt c) A
WHERE A.most_orders = 1 

--3.What’s the total revenue per product?

select p.product_name, SUM(price*quantity) as revenue 
